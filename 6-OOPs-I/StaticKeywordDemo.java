...
class Phone{
    ...
    public void showSpecs(){
        ...
        System.out.println("Phone name: " + this.name + "\nPrice: " + this.price + "\n"); // to fetch value of non static attributes we use this keyword        
        }

        /* now lets create a static method for the class: 
           A static method takes in an object as argument if it has to acess the instance variables
           because it would avoid confusion of which object's instance variables to acess
        */ 
